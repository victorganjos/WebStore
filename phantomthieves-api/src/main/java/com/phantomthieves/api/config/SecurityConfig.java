...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			...
			.antMatchers(HttpMethod.GET, "/carrinho/carrinho").permitAll()
			.antMatchers(HttpMethod.POST, "/carrinho/carrinho").permitAll()
			.antMatchers(HttpMethod.GET, "/carrinho/**").hasRole("CLIENT")
			.antMatchers(HttpMethod.POST, "/carrinho/**").hasRole("CLIENT")
			...
			.antMatchers(HttpMethod.GET, "/estoquista/**").hasRole("ESTOQUISTA")
			.antMatchers(HttpMethod.POST, "/estoquista/**").hasRole("ESTOQUISTA")
