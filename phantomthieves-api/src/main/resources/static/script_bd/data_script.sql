...
CREATE TABLE CLIENTE(
	...
	CIDADE_ENDERECO VARCHAR(150) NOT NULL,
...
CREATE TABLE ITEM_PEDIDO(
      COD_ITEM_PEDIDO INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,
      COD_PRODUTO INTEGER,
      QTDE INTEGER,
      VALOR DOUBLE,
      COD_PEDIDO INTEGER
...
UPDATE CLIENTE SET NOME_CLIENTE = "Victor",SOBRENOME_CLIENTE ="Goncalves",DDD_CLIENTE = "11",
TELEPHONE_CLIENTE ="959635436",DDD_CONTACT_CLIENTE = "11",TELEPHONE_CONTACT_CLIENTE = "959635436",
DATA_NASCIMENTO_CLIENTE ="19091994" WHERE COD_CLIENTE = 3;